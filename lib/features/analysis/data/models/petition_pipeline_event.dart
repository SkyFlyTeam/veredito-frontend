class PetitionPipelineEvent {
  ...
  factory PetitionPipelineEvent.fromJson(Map<String, dynamic> json) {
...
class ResumoEvent extends PetitionPipelineEvent {
  final String resumo;
...
class SearchEvent extends PetitionPipelineEvent {
...
class SynthesisEvent extends PetitionPipelineEvent {
  final int id;
...
class CompleteEvent extends PetitionPipelineEvent {
...
class ErrorEvent extends PetitionPipelineEvent {
