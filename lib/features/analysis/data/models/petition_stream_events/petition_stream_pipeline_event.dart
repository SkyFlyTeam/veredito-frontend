...
class PetitionStreamPipelineEvent extends StreamPipelineEvent {
  PetitionStreamPipelineEvent({required super.stage, required super.status, required super.timestamp, required super.duration, required super.data});

  static final StreamPipelineEventParser _parser = StreamPipelineEventParser({
    'resumo': (json, {entityKey}) => ResumoEvent.fromJson(json),
