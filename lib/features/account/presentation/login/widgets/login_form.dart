...
class _LoginFormState extends ConsumerState<LoginForm> {
  static const double _formWidth = 308;
  static const double _formHeight = 614;
  ...
  Widget build(BuildContext context) {
    ...
    final hasValidationError = authState.error != null;
      ...
      child: SingleChildScrollView(
        child: SizedBox(
          ...
          child: ConstrainedBox(
            constraints: const BoxConstraints(minHeight: _formHeight),
            child: Column(
              ...
              children: [
                ...
                if (authState.error != null) const SizedBox(height: 25),
